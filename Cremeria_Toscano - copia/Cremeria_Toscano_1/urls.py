...
urlpatterns = [
    ...
    path('ventas/', MostrarVenta.as_view(), name='ventas'),
    path('agregarVenta/', AgregarVenta.as_view(), name='agregarventa'),
    path('modificarVenta/<pk>', ModificarVenta.as_view(), name='modificarventa'),
    path('eliminarVenta/<pk>', EliminarVenta.as_view(), name='eliminarventa'),
